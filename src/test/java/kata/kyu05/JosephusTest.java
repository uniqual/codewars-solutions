...
import java.util.Arrays;
 ...
 class JosephusTest {
    ...
    @Test
    void test6() {
        josephusTest(new Object[]{true, true, false, true, false, true, false, false}, 3, new Object[]{false, true, true, false, true, false, true, false});
    }


    private void josephusTest(final Object[] items, final int k, final Object[] result) {
        Assertions.assertEquals(Arrays.asList(result), Josephus.josephusPermutation(new ArrayList<>(Arrays.asList(items)), k));
    }
}