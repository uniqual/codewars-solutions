...
class DirReductionTest {
    ...
    void testSimpleDirReduc() {
        ...
        assertArrayEquals(new String[]{"NORTH"}, DirReduction.dirReduc(new String[]{"NORTH","SOUTH","SOUTH","EAST","WEST","NORTH","NORTH"}));
        ...
        assertArrayEquals(new String[]{"NORTH", "EAST"}, DirReduction.dirReduc(new String[]{"NORTH", "EAST", "NORTH", "EAST", "WEST", "WEST", "EAST", "EAST", "WEST", "SOUTH"}));
        assertArrayEquals(new String[]{"NORTH", "WEST", "SOUTH", "EAST"}, DirReduction.dirReduc(new String[]{"NORTH", "WEST", "SOUTH", "EAST"}));
        assertArrayEquals(new String[]{"WEST", "WEST"}, DirReduction.dirReduc(new String[]{"EAST", "WEST", "WEST", "WEST"}));
    }
    ...
    @Test
    void testRandomDirReduc() throws Exception {
